    ...
    <div style="margin:20px 100px 20px 100px;min-height: 500px" class="layui-row layui-col-space10">
        <div>
            <span class="layui-breadcrumb">
                ...
                <a href="${pageContext.request.contextPath}/collection/showCollections"><cite>菜谱收藏</cite></a>
            </span>
        </div>
        <c:forEach items="${menus}" var="menu" varStatus="loop">
            <div style="padding: 15px;margin-bottom: 20px" class="layui-col-md6">
                ...
                <div class="layui-col-md6">
                    ...
                    <div>
                        <span>完成次数 ${collections[loop.count-1].complete} 次</span>
                        <button type="button" class="layui-btn" onclick="updateComplete(${collections[loop.count-1].complete},${collections[loop.count-1].menuId},${collections[loop.count-1].userId})">完成打卡</button>
                    </div>
                    <button class="layui-btn" onclick="deleteCollection(${collections[loop.count-1].menuId},${collections[loop.count-1].userId})">删除</button>
                </div>
            </div>
