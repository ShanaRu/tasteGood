...
<head>
    ...
    <script type="text/javascript">
        ...
        function changePageSize() {
            ...
            //向服务器发送请求，改变每页显示条数
            location.href = "${pageContext.request.contextPath}/work/userWorks?page=1&size="
                + pageSize;
        }
    </script>
</head>
...
<%--                        </a>--%>
            ...
            <div style="text-align: center" class="layui-col-md12">
                <%--首页--%>
                <a href="${pageContext.request.contextPath}/work/userWorks?page=1&size=${pageInfo.pageSize}">
                    <button class="layui-btn layui-btn-primary layui-btn-sm">首页</button>
                </a>
                <%--上一页--%>
                <c:if test="${pageInfo.hasPreviousPage}">
                    <a href="${pageContext.request.contextPath}/work/userWorks?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">
                ...
                <c:forEach items="${pageInfo.navigatepageNums}" var="pageNum">
                    <c:if test="${pageNum == pageInfo.pageNum}">
                        <a href="${pageContext.request.contextPath}/work/userWorks?page=${pageNum}&size=${pageInfo.pageSize}">
                ...
                <%--尾页--%>
                <a href="${pageContext.request.contextPath}/work/userWorks?page=${pageInfo.pages}&size=${pageInfo.pageSize}">
