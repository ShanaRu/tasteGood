    ...
    <div style="margin:20px 100px 20px 100px;min-height: 500px" class="layui-row layui-col-space30">
        ...
        <div class="layui-col-md10">
            <div class="layui-row layui-col-space30">
                <c:forEach items="${pageInfo.list}" var="followed">
                    <div class="layui-col-md3" style="text-align: center">
                        <a href="${pageContext.request.contextPath}/userInfo/kitchen?userId=${followed.userId}" style="display: inline-block;line-height:0;">
                            <img src="${pageContext.request.contextPath}/${followed.userPhoto}" style="width: 100px;height: 100px;vertical-align:bottom;border-radius:50%;" alt="*">
                        </a>
                        <p style="padding: 15px">
                            <a href="${pageContext.request.contextPath}/userInfo/kitchen?userId=${followed.userId}"><h3 style="text-align: center">${followed.userName}</h3></a>
                        </p>
                    </div>
                </c:forEach>
                <div style="text-align: center" class="layui-col-md12">
                    <%--首页--%>
                    <a href="${pageContext.request.contextPath}/userInfo/showFollowed?userId=${userInfo.userId}&page=1&size=${pageInfo.pageSize}">
                        <button class="layui-btn layui-btn-primary layui-btn-sm">首页</button>
                    </a>
                    <%--上一页--%>
                    <c:if test="${pageInfo.hasPreviousPage}">
                        <a href="${pageContext.request.contextPath}/userInfo/showFollowed?userId=${userInfo.userId}&page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">
                    ...
                    <c:forEach items="${pageInfo.navigatepageNums}" var="pageNum">
                        <c:if test="${pageNum == pageInfo.pageNum}">
                            <a href="${pageContext.request.contextPath}/userInfo/showFollowed?userId=${userInfo.userId}&page=${pageNum}&size=${pageInfo.pageSize}">
