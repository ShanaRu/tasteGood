...
<head>
    ...
    <script type="text/javascript">
        ...
        function deleteFollow(userId,follow) {
            console.log("123");
            layui.use('layer', function(){
                var layer = layui.layer;
                layer.confirm('确定要取消关注吗？', {
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath}/userInfo/deleteFollow",
                        data:{"userId":userId,"follow":follow},
                        datatype:"text",
                        type:"post",
                        success:function (data) {
                            if(data=="200"){
                                layer.msg('取消关注成功', {icon: 1,offset:'220px'},);
                                ...
                                layer.msg('无法取消关注', {icon: 5,offset:'220px'},);
                            }
                        },
                        error:function () {
                            layer.msg('无法取消关注', {icon: 5,offset:'220px'},);
...
<body>
    ...
    <div style="margin:20px 100px 20px 100px;min-height: 500px" class="layui-row layui-col-space30">
        <div class="layui-col-md2">
            ...
            <p style="text-align: center;padding: 15px;"><a href="${pageContext.request.contextPath}/userInfo/showFollow?userId=${userInfo.userId}&page=1&size=16" class="layui-btn layui-btn-primary">关注 ${followNum}</a></p>
            <p style="text-align: center;padding: 15px;"><a href="${pageContext.request.contextPath}/userInfo/showFollowed?userId=${userInfo.userId}&page=1&size=16" class="layui-btn layui-btn-primary">被关注 ${followedNum}</a></p>
            <ul>
        ...
        <div class="layui-col-md10">
            <div class="layui-row layui-col-space30">
                <c:forEach items="${pageInfo.list}" var="follow">
                    <div class="layui-col-md3" style="text-align: center">
                        <a href="${pageContext.request.contextPath}/userInfo/kitchen?userId=${follow.userId}" style="display: inline-block;line-height:0;">
                            <img src="${pageContext.request.contextPath}/${follow.userPhoto}" style="width: 100px;height: 100px;vertical-align:bottom;border-radius:50%;" alt="*">
                        </a>
                        <p style="padding: 15px">
                            <a href="${pageContext.request.contextPath}/userInfo/kitchen?userId=${follow.userId}"><h3 style="text-align: center">${follow.userName}</h3></a>
                        </p>
                        <c:if test="${myUserId eq userInfo.userId}">
                            <p style="text-align: center;margin: 15px">
                                <button type="button" class="layui-btn layui-btn-danger layui-btn-xs" onclick="deleteFollow(${myUserId},${follow.userId})">取消关注</button>
                            </p>
                        </c:if>
                ...
                <div style="text-align: center" class="layui-col-md12">
                    <%--首页--%>
                    <a href="${pageContext.request.contextPath}/userInfo/showFollow?userId=${userInfo.userId}&page=1&size=${pageInfo.pageSize}">
                        <button class="layui-btn layui-btn-primary layui-btn-sm">首页</button>
                    </a>
                    <%--上一页--%>
                    <c:if test="${pageInfo.hasPreviousPage}">
                        <a href="${pageContext.request.contextPath}/userInfo/showFollow?userId=${userInfo.userId}&page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">
                    ...
                    <c:forEach items="${pageInfo.navigatepageNums}" var="pageNum">
                        <c:if test="${pageNum == pageInfo.pageNum}">
                            <a href="${pageContext.request.contextPath}/userInfo/showFollow?userId=${userInfo.userId}&page=${pageNum}&size=${pageInfo.pageSize}">
                    ...
                    <%--尾页--%>
                    <a href="${pageContext.request.contextPath}/userInfo/showFollow?userId=${userInfo.userId}&page=${pageInfo.pages}&size=${pageInfo.pageSize}">
