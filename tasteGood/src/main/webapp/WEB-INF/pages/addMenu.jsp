...
<%--                <form class="layui-form">--%>
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <textarea name="menuDetail" id="menuDetail" placeholder="请输入菜谱描述" class="layui-textarea" required lay-verify="required"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="layui-row layui-col-space10">
                                <div class="layui-col-md6" id="dosageBox1"></div>
                                <div class="layui-col-md6" id="dosageBox2"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            <textarea name="tip" placeholder="请输入提示" id="tip" class="layui-textarea" required  lay-verify="required"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
